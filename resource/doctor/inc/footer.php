...
<div class="sidebar-menu">
    ...
    <div class="menu">
        <ul id="menu" >
            ...
            <li id="menu-academico" ><a href="doctorDetails.php"><i class="fa fa-table"></i> <span>Doctor Profile</span></a></li>
            <li id="menu-academico" ><a href="doctorSchedule.php"><i class="fa fa-table"></i> <span>Your Schedule</span></a></li>
            <li id="menu-academico" ><a href="#"><i class="lnr lnr-layers"></i> <span>Improve Your Account</span> <span class="fa fa-angle-right" style="float: right"></span></a>
                <ul id="menu-academico-sub" >
                    <li id="menu-academico-avaliacoes" ><a href="degreeStore.php">Degree Info</a></li>
                    <li id="menu-academico-boletim" ><a href="researchPaper.php">Research Paper</a></li>
                    <li id="menu-academico-boletim" ><a href="achievement.php">Achievement</a></li>
                    <li id="menu-academico-boletim" ><a href="engagedWith.php">Engaged Org/Grp</a></li>
                    <li id="menu-academico-boletim" ><a href="webContent.php">Web Content</a></li>
