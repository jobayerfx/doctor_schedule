...
$allData = $objPatient->trashed("obj");
...
$someData = $objPatient->trashedPaginator($page,$itemsPerPage);
    ...
    <nav class="women_main">
        <div class="w_content">
            <div class="panel-title">
                Doctor Schedule Management (DSM) || Trashed Patient List
            ...
            <div class="women">
                <div class="">
                    <form id="selectForm" action="markedPatient.php" method="post">
                        ...
                        <button class="btn btn-inverse" name="recoverMarkAll">Recover All</button> &nbsp;&nbsp;
                        <button class="btn btn-danger" name="deleteMarkAll" Onclick="return ConfirmDelete()">Delete All</button>
                </div>
                <h4>
                    Total Number of Trashed Listed Patient -
                        ...
                        echo "      
                               <tr>
                                   ...
                                   <td>
                                    ...
                                    <td><p data-placement=\"top\" data-toggle=\"tooltip\" title=\"Recover\"><a href='recoverPatient.php?id=$values->id' class=\"btn btn-danger btn-xs\" data-title=\"Recover\" data-toggle=\"modal\" data-target=\"#recover\" ><span class=\"glyphicon glyphicon-repeat\"></span></a></p></td>
                                    <td><p data-placement=\"top\" data-toggle=\"tooltip\" title=\"Delete\"><a href='deletePatient.php?id=$values->id' Onclick=\"return ConfirmDelete()\" class=\"btn btn-danger btn-xs\" data-title=\"Delete\" data-toggle=\"modal\" data-target=\"#delete\" ><span class=\"glyphicon glyphicon-remove\"></span></a></p></td>
                    ...
                    if ($page > $pages){
                        echo "<div class=\"pagination\">
                                        <ul>
                                            ...
                                            <li class=\"page-item disabled\">
                                            <a class=\"page-link\" href=\"patientTrashed.php?Page= 1\" tabdoctorList=\"-1\" aria-label=\"Previous\">
                        ...
                        <?php elseif ($page == $pages): ?>
                            <li class="page-item">
                                <a class="page-link" href='patientTrashed.php?Page=<?php echo $page - 1; ?>' tabindex="-1" aria-label="Previous">
                                    <span aria-hidden="true">&laquo;</span>
                                    <span class="sr-only">Previous</span>
                                </a>
                            </li>
                        ...
                        for ($i = 1; $i <= $pages; $i++):
                            ...
                            <li class=' page-link <?php if ($i == $page) echo 'active'; ?>' id="<?php echo $i; ?>">
                                <a class="page-link" href='patientTrashed.php?Page=<?php echo $i; ?>'><?php echo $i; ?> <span class="sr-only">(current)</span></a>
                            </li>
                        <?php endfor; ?>
                        <?php
                        if ($page == $pages ): ?>
                        ...
                        <?php else: ?>
                            <li class="page-item">
                                <a class="page-link" href='patientTrashed.php?Page=<?php echo $page + 1; ?>' aria-label="Next">
                                    <span aria-hidden="true">&raquo;</span>
                                    <span class="sr-only">Next</span>
                                </a>
                            </li>
