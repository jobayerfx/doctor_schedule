            ...
            foreach($someData as $key => $values){
                ...
                <div class="grids_of_4">
                    <div class="grid1_of_4">
                        <div class="content_box"><a href="doctorSchedule.php?d_id=<?php echo $values->id ?>">
                                <img title="Doctor Picture" src="../../resource/drPicture/<?php echo $values->picture ?>" class="img-responsive" alt="">
                            </a>
                            <h4><a href="doctorDetails.php?id=<?php echo $values->id ?>"> <?php echo $values->dr_name ?></a></h4>
                            <p>&nbsp; ID - <?php echo $values->id ?></p>
                            <div class="grid_1 simpleCart_shelfItem">
                                ...
                                <div class="item_add"><span class="item_price"><h6><?php echo $values->email ?></h6></span></div>
                                <div class="item_add"><span class="item_price"><a href="doctorSchedule.php?d_id=<?php echo $values->id ?>">Mange Schedule</a></span></div>
                                <ul class="w_nav">
                                </ul>
                            </div>
                        </div>
                ...
                <?php if(!empty($pages)):
                    ...
                    if ($page > $pages){
                        ...
                        <?php elseif ($page == $pages): ?>
                            <li class="page-item">
                                <a class="page-link" href='doctorScheduleList.php?Page=<?php echo $page - 1; ?>' tabindex="-1" aria-label="Previous">
                                    <span aria-hidden="true">&laquo;</span>
                                    <span class="sr-only">Previous</span>
                                </a>
                            </li>
                        ...
                        for ($i = 1; $i <= $pages; $i++):
                            ...
                            <li class=' page-link <?php if ($i == $page) echo 'active'; ?>' id="<?php echo $i; ?>">
                                <a class="page-link" href='doctorScheduleList.php?Page=<?php echo $i; ?>'><?php echo $i; ?> <span class="sr-only">(current)</span></a>
                            </li>
                        <?php endfor; ?>
                        <?php
                        if ($page == $pages ): ?>
                        ...
                        <?php else: ?>
                            <li class="page-item">
                                <a class="page-link" href='doctorScheduleList.php?Page=<?php echo $page + 1; ?>' aria-label="Next">
                                    <span aria-hidden="true">&raquo;</span>
                                    <span class="sr-only">Next</span>
                                </a>
                            </li>
