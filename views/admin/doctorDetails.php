                    ...
                    <div class="container-fluid"><hr>
                        <div class="row-fluid">
                                                        ...
                                                        <div class=" col-md-9 col-lg-9 ">
                                                            <table class="table table-user-information">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <?php $cat = $obj->viewSpecialistById($singleData->specialist_id); ?>
                                                                    <td><?php echo $cat->specialist ?></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Phone Number:</td>
                            ...
                            <div class="panel-footer">
                                 <a class="btn btn-sm btn-primary" type="button" data-toggle="tooltip" data-original-title="Trash the doctor" href="trash_doctor.php?id=<?php echo $singleData->id; ?>">
								...
								<span class="pull-right">
									...
									<a onclick="return confirm('Are you want to Delete Doctor?')" class="btn btn-sm btn-danger" type="button" data-toggle="tooltip" data-original-title="Remove this doctor" href="delete_doctor.php?id=<?php echo $singleData->id; ?>">
                                        <i class="glyphicon glyphicon-remove"></i>
                                            ...
                                            <?php
                                            $sdl_data = $obj->viewSchedule($singleData->unique_id);
                                            ?>
                                            <div class="panel panel-info">
                                                <div class="panel-heading">
                                                        ...
                                                        <div class=" col-md-9 col-lg-9 ">
                                                            <table class="table table-user-information">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo $obj->timeFormat($sdl_data->morning_time_from); ?></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Morning Time To:</td>
                                                                    <td><?php echo $obj->timeFormat($sdl_data->morning_time_to); ?></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Evening Vanue:</td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo $obj->timeFormat($sdl_data->evening_time_from); ?></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Evening Time To:</td>
                                                                    <td><?php echo $obj->timeFormat($sdl_data->evening_time_to); ?></td>
                                                                </tr>
                                                                <tr>
