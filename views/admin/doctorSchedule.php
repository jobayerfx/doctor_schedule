...
if (array_key_exists('d_id',$_REQUEST)){
    $_SESSION['d_id'] = $_GET['d_id'];

    if ($isDoctorExists == true){

    }else{
        Utility::redirect('doctorScheduleList.php');
    }
}
...
<div class="content" xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html">
   <div class="women_main">
       ...
       <table class="table table-hover">
           ...
           <?php
           $j= 0;
           foreach ($rowMoring as $singleBooking){
...
<?php include "../../resource/admin/inc/footer.php"; ?>
    ...
    <script>
        function ConfirmDelete() {
            var x = confirm("Is Mail it? _ Are you sure you want to The Doctor Schedule Data? ");
            if (x)
                return true;
            else
                return false;
