...
$allData = $objLibrary->trashed("obj");
...
$someData = $objLibrary->trashedPaginator($page,$itemsPerPage);
    ...
    <nav class="women_main">
        <div class="w_content">
            <div class="panel-title">
                Doctor Schedule Management (DSM) || Trashed Doctor List
            ...
            <div class="women">
                <div class="">
                    <form id="selectForm" action="marked.php" method="post">
                        ...
                        <button class="btn btn-inverse" name="recoverMarked">Recover All</button> &nbsp;&nbsp;
                        <button class="btn btn-danger" name="deleteMarked">Delete All</button>
                </div>
                <h4>
                    Total Number of Doctor (Trashed) -
                    ...
                    if ($page > $pages){
                        echo "<div class=\"pagination\">
                                        <ul>
                                            ...
                                            <li class=\"page-item disabled\">
                                            <a class=\"page-link\" href=\"doctorTrashList.php?Page= 1\" tabdoctorList=\"-1\" aria-label=\"Previous\">
                        ...
                        <?php elseif ($page == $pages): ?>
                            <li class="page-item">
                                <a class="page-link" href='doctorTrashList.php?Page=<?php echo $page - 1; ?>' tabindex="-1" aria-label="Previous">
                                    <span aria-hidden="true">&laquo;</span>
                                    <span class="sr-only">Previous</span>
                                </a>
                            </li>
                        ...
                        for ($i = 1; $i <= $pages; $i++):
                            ...
                            <li class=' page-link <?php if ($i == $page) echo 'active'; ?>' id="<?php echo $i; ?>">
                                <a class="page-link" href='doctorTrashList.php?Page=<?php echo $i; ?>'><?php echo $i; ?> <span class="sr-only">(current)</span></a>
                            </li>
                        <?php endfor; ?>
                        <?php
                        if ($page == $pages ): ?>
                        ...
                        <?php else: ?>
                            <li class="page-item">
                                <a class="page-link" href='doctorTrashList.php?Page=<?php echo $page + 1; ?>' aria-label="Next">
                                    <span aria-hidden="true">&raquo;</span>
                                    <span class="sr-only">Next</span>
                                </a>
                            </li>
