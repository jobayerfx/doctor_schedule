...
<!-- Mirrored from themes.webinane.com/medicalist/events.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Nov 2016 05:50:35 GMT -->
<head>
...
<div class="pagetop">
	<div class="container">
		...
		<h1><span>MEDICALIST</span> EVENTS</h1>
		<ul>
					...
					<div class="all-events">
						<div class="row">
							<div class="col s12 m6 l4">
								<div class="event">
									<div class="event-top">
										<div class="event-img"><img src="images/resource/event1.jpg" alt="" /></div>
										<div class="event-detail">
											<div class="org">
												<img src="images/resource/organizer.jpg" alt="" />
												<span>Anjori Mayami <i>( Organizer )</i></span>
											</div>
											<h4><a href="event-detail.html" title="">Language Trainings: Efficient Negotiating </a></h4>
										</div>
										<div class="map"><div id="map-canvas"></div></div>				
									</div>
									<div class="event-bottom">
										<span class="map-icon"><i class="fa fa-map-marker"></i></span>
										<span class="event-date">20 November 2016</span>
										<span class="event-time">11:00 PM - 12:00 AM</span>
									</div>
								</div><!-- Event -->
							</div>
							<div class="col s12 m6 l4">
								<div class="event">
									<div class="event-top">
										<div class="event-img"><img src="images/resource/event2.jpg" alt="" /></div>
										<div class="event-detail">
											<div class="org">
												<img src="images/resource/organizer.jpg" alt="" />
												<span>Anjori Mayami <i>( Organizer )</i></span>
											</div>
											<h4><a href="event-detail.html" title="">Language Trainings: International Record-Keeping </a></h4>
										</div>
										<div class="map"><div id="map-canvas2"></div></div>				
									</div>
									<div class="event-bottom">
										<span class="map-icon"><i class="fa fa-map-marker"></i></span>
										<span class="event-date">20 November 2016</span>
							...
							<div class="col s12 m6 l4">
								<div class="event">
									<div class="event-top">
										<div class="event-img"><img src="images/resource/event3.jpg" alt="" /></div>
										<div class="event-detail">
											<div class="org">
												<img src="images/resource/organizer.jpg" alt="" />
												<span>Anjori Mayami <i>( Organizer )</i></span>
											</div>
											<h4><a href="event-detail.html" title="">Exercitation Ullamco Laboris Nisi Ut Aliquip Consequat Duis</a></h4>
										</div>
										<div class="map"><div id="map-canvas3"></div></div>				
									</div>
									<div class="event-bottom">
										<span class="map-icon"><i class="fa fa-map-marker"></i></span>
										<span class="event-date">20 November 2016</span>
							...
							<div class="col s12 m6 l4">
								<div class="event">
									<div class="event-top">
										<div class="event-img"><img src="images/resource/event4.jpg" alt="" /></div>
										<div class="event-detail">
											<div class="org">
												<img src="images/resource/organizer.jpg" alt="" />
												<span>Anjori Mayami <i>( Organizer )</i></span>
											</div>
											<h4><a href="event-detail.html" title="">Donec Gravida, Dolor Ut Auctor Consequat Duis Facilisis</a></h4>
										</div>
										<div class="map"><div id="map-canvas4"></div></div>				
									</div>
									<div class="event-bottom">
										<span class="map-icon"><i class="fa fa-map-marker"></i></span>
										<span class="event-date">20 November 2016</span>
							...
							<div class="col s12 m6 l4">
								<div class="event">
									<div class="event-top">
										<div class="event-img"><img src="images/resource/event5.jpg" alt="" /></div>
										<div class="event-detail">
											<div class="org">
												<img src="images/resource/organizer.jpg" alt="" />
												<span>Anjori Mayami <i>( Organizer )</i></span>
											</div>
											<h4><a href="event-detail.html" title="">Ullamco Laboris Nisi Ut Consequat Duis Dolor Ut Auctor</a></h4>
										</div>
										<div class="map"><div id="map-canvas5"></div></div>				
									</div>
									<div class="event-bottom">
										<span class="map-icon"><i class="fa fa-map-marker"></i></span>
										<span class="event-date">20 November 2016</span>
							...
							<div class="col s12 m6 l4">
								<div class="event">
									<div class="event-top">
										<div class="event-img"><img src="images/resource/event6.jpg" alt="" /></div>
										<div class="event-detail">
											<div class="org">
												<img src="images/resource/organizer.jpg" alt="" />
												<span>Anjori Mayami <i>( Organizer )</i></span>
										...
										<div class="map"><div id="map-canvas6"></div></div>				
									</div>
									<div class="event-bottom">
										<span class="map-icon"><i class="fa fa-map-marker"></i></span>
										<span class="event-date">20 November 2016</span>
	...
	<script type="text/javascript">
		jQuery (document).ready(function () {
			...
			function initialize() {
			  ...
			  var map4 = new google.maps.Map(document.getElementById('map-canvas4'), mapOptions);
			  var map5 = new google.maps.Map(document.getElementById('map-canvas5'), mapOptions);
			  var map6 = new google.maps.Map(document.getElementById('map-canvas6'), mapOptions);
...
<!-- Mirrored from themes.webinane.com/medicalist/events.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Nov 2016 05:54:12 GMT -->
</html>