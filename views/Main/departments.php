...
<!-- Mirrored from themes.webinane.com/medicalist/departments.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Nov 2016 05:48:15 GMT -->
<head>
...
<div class="pagetop">
	<div class="container">
		...
		<h1><span>MEDICALIST</span> DEPARTMENTS</h1>
		<ul>
		...
		<div class="container">
			<div class="row">
				<div class="col column s12 m12 l12">
					<div class="creative-departments">
						<ul>
							<li class="creative-dep">
								<img src="images/resource/creative-dep1.jpg" alt="" />
								<div class="dep-details">
									<div class="dep-inner">
										<span><i class="icon-dental"></i></span>
										<i>ONLINE HASSLE</i>
										<h4>Tobacco Cessation</h4>
										<a href="department-detail.html" title="">See Detail <i class="fa fa-caret-right"></i></a>
									</div>
								</div>
							</li><!-- Creative Dep -->
							<li class="creative-dep">
								<img src="images/resource/creative-dep2.jpg" alt="" />
								<div class="dep-details">
									<div class="dep-inner">
										<span><i class="icon-cut"></i></span>
										<i>ONLINE HASSLE</i>
										<h4>Outpatient</h4>
										<a href="department-detail.html" title="">See Detail <i class="fa fa-caret-right"></i></a>
									</div>
							...
							<li class="creative-dep">
								<img src="images/resource/creative-dep3.jpg" alt="" />
								<div class="dep-details">
									<div class="dep-inner">
										<span><i class="icon-virus"></i></span>
										<i>ONLINE HASSLE</i>
										<h4>Inpatient Surgical</h4>
										<a href="department-detail.html" title="">See Detail <i class="fa fa-caret-right"></i></a>
									</div>
								</div>
							</li><!-- Creative Dep -->
							<li class="creative-dep">
								<img src="images/resource/creative-dep4.jpg" alt="" />
								<div class="dep-details">
									<div class="dep-inner">
							...
							<li class="creative-dep">
								<img src="images/resource/creative-dep5.jpg" alt="" />
								<div class="dep-details">
									<div class="dep-inner">
							...
							<li class="creative-dep">
								...
								<div class="dep-details">
									<div class="dep-inner">
										<span><i class=" icon-medical-bag"></i></span>
										<i>ONLINE HASSLE</i>
										<h4>Breast Clinic</h4>
										<a href="department-detail.html" title="">See Detail <i class="fa fa-caret-right"></i></a>
									</div>
							...
							<li class="creative-dep">
								...
								<div class="dep-details">
									<div class="dep-inner">
										<span><i class="icon-bandage"></i></span>
										<i>ONLINE HASSLE</i>
