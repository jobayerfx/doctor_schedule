...
<div class="theme-layout">
	...
	<div class="pagetop">
		<div class="container">
			...
			<h1><span>MEDICALIST</span> REGISTRATION </h1>
			<ul>
					...
					<div class="col offset-l1 l10 m12 s12 column">
						<div class="registration-page">
							...
							<div class="theme-form registration-form">
								...
								<form action="User/Profile/registration.php" method="post">
									<div class="input-field col s12"><input type="text" name="patient_name" placeholder="Complete Name" required="" /></div>
									<div class="input-field col s12"><input type="email" name="email" placeholder="Email Address" required=""/></div>
									<div class="input-field col s12"><input type="text" name="patient_phone" placeholder="Phone Number" required=""/></div>
									...
									<div class="input-field col s12">
										<input type="text" name="patient_address" placeholder="Patient Address" />
									</div>
									<div class="input-field col s12"><input type="password" name="password" placeholder="Password" /></div>
									<div class="input-field col s12"><input type="password" name="password2" placeholder="Confirm Password" /></div>
								...
								<form action="login.php" >
									<div class="other-logins button">
										...
										<button type="submit"><i class="fa fa-user-md"></i> Please Login Now</button>
									</div>
								</form>
	...
	<div class="bottom-footer">
		<div class="container">
			<p><a href="#" title=""> Sohojlovvo © 2018.</a> All Rights Reserved. </p>
			<ul>
				<li><a href="Non-index.php" title="">Home</a></li>
