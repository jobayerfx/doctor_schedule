				...
				<div class="col l4 m12 s12 column">
					<div class="timetable">
						<div class="classic-title">
							<h2><span>Check Our</span>Weekly Timetable</h2>
						</div>
...
<section>
	<div class="block no-padding">
		<div class="container">
			<div class="row">
				<div class="col l12 m12 s12 column">
					<div class="departments with-img overlap">
						<span><img src="images/resource/department-girl.png" alt="" /></span>
						<div class="row">
							<div class="col l4 m12 s12">
								<div class="about-departments">
									<h6><span>Our Medical</span> Departments</h6>
									<p>Suspendisse potenti. Maecenas dapibus ac tellus sed pulvinar. Vestibulum bib volutpat accumsan non laoreet...</p>
									<a href="departments.html" title="">See All Departments <i class="fa fa-caret-right"></i></a>
								</div><!-- About Departments -->
							</div>
							<div class="col l4 m12 s12">
								<ul class="list">
									<li><a href="department-detail.html" title=""> Anesthesiology & Pain Management</a></li>
									<li><a href="department-detail.html" title=""> Cancer (Taussig)</a></li>
									<li><a href="department-detail.html" title=""> Children's</a></li>
									<li><a href="department-detail.html" title=""> Dermatology & Plastic Surgery</a></li>
									<li><a href="department-detail.html" title=""> Digestive Disease</a></li>
									<li><a href="department-detail.html" title=""> Endocrinology & Metabolism</a></li>
									<li><a href="department-detail.html" title=""> Genomic Medicine</a></li>
								</ul>
							</div>
							<div class="col l4 m12 s12">
								<ul class="list">
				...
				<div class="col l3 m6 s12">
					<div class="widget">
						<div class="gallery-widget">
							<div class="row">
								<div class="col l6 m6 s6"><img class="materialboxed" data-caption="A picture of some deer and tons of trees" src="images/resource/gallery-widget1.jpg" alt="" /></div>
								<div class="col l6 m6 s6"><img class="materialboxed" data-caption="A picture of some deer and tons of trees" src="images/resource/gallery-widget2.jpg" alt="" /></div>
								<div class="col l6 m6 s6"><img class="materialboxed" data-caption="A picture of some deer and tons of trees" src="images/resource/gallery-widget3.jpg" alt="" /></div>
								<div class="col l6 m6 s6"><img class="materialboxed" data-caption="A picture of some deer and tons of trees" src="images/resource/gallery-widget4.jpg" alt="" /></div>
							</div>
						</div>
					</div><!-- Widget -->
				</div>
...
<div class="popup">
	...
	<script type="text/javascript" src="js/revolution/revolution.initialize2.js"></script>
